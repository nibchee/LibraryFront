                        ...
                        <div className="row">
                            ...
                            <div className="col-md-3 mb-3">
                                ...
                                <input type="text" className="form-control" name='author'
                                    required onChange={e => setAuthor(e.target.value)} value={author} />
                            </div>
                            <div className="col-md-3 mb-3">
                                ...
                                <u id='addNewBookId' className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <li><a onClick={() => categoryField('Data')} className="dropdown-item">Big Data</a></li>
